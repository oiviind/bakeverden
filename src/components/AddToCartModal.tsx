      ...
      >
        ...
        >
          <div className="p-6">
            ...
            {/* Bilde - 40x40px (10x10 var alt for lite) */}
            {batch.image_url && (
              <img 
                src={batch.image_url} 
                alt={batch.title}
            ...
            <div className="flex gap-2">
              <button
                onClick={onClose}
                className="flex-1 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg font-semibold text-gray-700"
              >
                Avbryt
              </button>
              <button
