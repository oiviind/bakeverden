        ...
        <div className={styles.content}>
          <div>
            ...
            <ul className={styles.links}>
              <li>📧 <a href="mailto:kjerstisbakeverden@gmail.com">kjerstisbakeverden@gmail.com</a></li>
              <li>📞 <a href="tel:+4745477878">+47 454 77 878</a></li>
            </ul>
          </div>

          <div>
            <h4 className={styles.heading}>Følg meg</h4>
            <div className={styles.social}>
              <a
                href="https://www.facebook.com/Kjerstisbakeverden/"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/kjerstisbakeverden"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.socialLink}
